...
<!-- 导航  end --> 
	...
	<ul class="maincontent">
		<?php if(is_array($list)): $k = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($k % 2 );++$k; if($k%2!=0) : ?>	
		
		<li id="subnav<?php echo ($k); ?>" data-title="<?php echo ($r["title"]); ?>" style="background: #e9e7e4 url('<?php echo ($r["bg"]); ?>') center top no-repeat;">
			<div class="difference_teaser ">
				<div class="text_box_right">
					<div class="headline">
						<h3 class="double"><div class=""><?php echo ($r["title"]); ?></div></h3>
					</div>
					<div class="text">
						
<div class=""><?php echo ($r["description"]); ?></div>							</div>
					<a href="/contact/"  class="btn_full_teaser">Online consulting</a>
				</div>
			</div>
		</li>
		...
		<li id="subnav<?php echo ($k); ?>" data-title="<?php echo ($r["title"]); ?>" style="background: #004561 url('<?php echo ($r["bg"]); ?>') center top no-repeat;">
			<div class="difference_teaser ">
				<div class="text_box_left bai">
					<div class="headline">
						<h3 class="double"><div class=""><?php echo ($r["title"]); ?></div></h3>
					</div>
					<div class="text">
...
<div class=""><?php echo ($r["description"]); ?></div></div>
					<?php if($k==4) : ?>
					<a href="http://gzjym.vip.360fob.com/cargowebsite/websiteEn/style_two/index.html
"  class="btn_full_teaser" target="_blank">More queries</a>
					<?php else :?>
					<a href="/contact/"  class="btn_full_teaser">Online consulting</a>
...
$(function(){
	if($(window).width()<768){
		$('#pic li:odd').css('background-position','35% center');
		$('#pic li:even').css('background-position','75% center');
		$('#pic #subnav7').css('background-position','60% center');
		$('#pic #subnav1').css('background-position','90% center');
		$('#pic #subnav3').css('background-position','90% center');
	}
