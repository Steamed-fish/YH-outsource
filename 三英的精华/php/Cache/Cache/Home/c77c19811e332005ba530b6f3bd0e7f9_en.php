...
<main>
  <ul class="maincontent">
    <li id="subnav1" data-title="News" style="background: #f5f7f8 url(../Public/images/new_bg.jpg) no-repeat center center;">
      <div class="page_headline_block">
        <h3 class="bai">News</h3>
        <div  class="text bai">
    ...
    <!--2-->
    <li id="subnav2" data-title="new list" style="background: #FFFFFF ;">
      <div class="new clearfix">
      	<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><dl>
			<dt><img src="<?php echo ($r["thumb"]); ?>"  width="100%"/></dt>
			<dd>
				<a href="<?php echo ($r["url"]); ?>"><h3><?php echo (todate($r["createtime"],'Y-m')); ?> | <?php echo ($r["title"]); ?></h3></a>
				<p><?php echo ($r["description"]); ?></p>
				<a href="<?php echo ($r["url"]); ?>">&gt read more</a>
			</dd>
