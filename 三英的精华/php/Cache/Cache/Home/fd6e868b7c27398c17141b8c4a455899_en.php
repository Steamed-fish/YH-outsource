...
<!-- header -->
	...
	<div class="nav_wrapper">
        ...
        <!-- /.navbar-collapse -->
			<a href="http://dev.kinnit.com:24180/App/CargoTracking" class="search search_bar_box">TRACKING</a>
...
<!-- 导航  end --> 
		...
		<div id="news_de">
	<?php  $pre=M($module)->where("id<$id and catid=$catid and lang=$lang")->find(); $next=M($module)->where("id>$id and catid=$catid and lang=$lang")->find(); ?> 
<main>
  <ul class="maincontent">
    <li id="subnav1" data-title="News" style="background: #f5f7f8 url(../Public/images/news_de.jpg) no-repeat center center;">
      <div class="page_headline_block">
      	

        <h3 class="bai"><?php echo (todate($createtime,'Y-m')); ?> | <?php echo ($title); ?></h3>
        <div  class="text bai">
    ...
    <li id="subnav2" data-title="new list" style="background: #FFFFFF ;">
      ...
      <div class="newde clearfix">
      	...
      	<div class="xiaye pd f14 lh22" style="padding-top: 0;">
        	<p class="shang"><span class="fw">Previous :</span><a href="<?php echo ($pre["url"]); ?>"><?php if($pre) : echo ($pre["title"]); else : endif;?></a></p>
        	<p class="xia"><span class="fw">Next :</span><a href="<?php echo ($next["url"]); ?>"><?php echo ($next["title"]); ?></a></p>
        </div>
