...
<!-- 导航  end --> 
		...
		<main>
	<ul class="maincontent start">
		<li id="subnav1" data-title="WELCOME" class="stageslider">
			<!--banner-->
				...
				<div id="bannerscollection_zoominout_opportune">
					...
					<ul class="bannerscollection_zoominout_list">
						...
						<li data-horizontalPosition="center" data-verticalPosition="center" data-initialZoom="1" data-finalZoom="1.6" data-text-id="#bannerscollection_zoominout_photoText<?php echo ($i); ?>" data-duration="75" data-autoPlay="10"><img src="<?php echo ($r['pic']); ?>"  width="1920" height="787" name="" alt="no-img" />
						</li>
						<?php endforeach; endif;?>							
											</ul>
					<!-- TEXTS -->
                    <?php  $_result=M('Slide_data')->where(" status=1 and  fid=1  and lang=2")->order(" listorder ASC ,id DESC ")->limit("5")->select();;if ($_result): $i=0;foreach($_result as $key=>$r):$i++;$mod = ($i % 2 );parse_str($r['data'],$r['param']);?>
					<div id="bannerscollection_zoominout_photoText<?php echo ($i); ?>" class="bannerscollection_zoominout_texts">
							<div class="textElement_opportune black" 
								 data-initial-left="0" 
			...
			<div class="slider_nav_bg"></div>

			<!--banner-->

		</li>
		<li id="subnav3" data-title="Overview" class="hide_low_768">
			<div class="page_teaser">
				<div class="profile_button_container">
					<div class="icon_list">
						<div data-profilenumber="1" class="float_left">
							<div class="profile_symbol float_left">
								<div class="icon_text">Company Profile</div>
								<a href="/about/" ><div class="icon_tool"></div></a>
							</div>
							<div class="profile_undertitle float_left">
								<span style="color:#333333;font-family:tahoma;font-size:14px;text-align:center;white-space:normal;background-color:#FFFFFF;">This document provides enough information on our organizational focus, specialization, and expertise</span> 								
								<div class="read_more"><a href="solution.html" >read more</a>
									
								</div>
							</div>
						</div>
						<div data-profilenumber="2">
							<div class="profile_symbol centerize">
								<div class="icon_text">Service project</div>
								<a href="/service/" ><div class="icon_spot"></div></a>
							</div>
							<div class="profile_undertitle centerize">
								<span style="color:#333333;font-family:tahoma;font-size:14px;text-align:center;white-space:normal;background-color:#FFFFFF;">Our company has good relations with International well-known Ocean carriers especially Africa line , we signed contracts with many ocean carriers ,we are not only assure customer space, but also offer our customer better rate and service.</span> 							<div class="read_more"><a href="Team.html" >read more</a></div>
							</div>
						</div>
						<div data-profilenumber="3" class="float_right">
							<div class="profile_symbol float_right">
								<div class="icon_text">Contact us</div>
								<a href="/contact/" ><div class="icon_signpost"></div></a>
							</div>
							<div class="profile_undertitle float_right">
								<p>
	<span style="color:#333333;font-family:tahoma;font-size:14px;text-align:center;white-space:normal;background-color:#FFFFFF;">Add: No.2411 Grandby Xinyi Building, 18 Xihu Road,Yuexiu district, Guangzhou,China</span>
</p>
<p>
	<span style="color:#333333;font-family:tahoma;font-size:14px;text-align:center;white-space:normal;background-color:#FFFFFF;">Tel :+86-20-83310562&nbsp;</span>
</p>
<p>
	<span style="color:#333333;font-family:tahoma;font-size:14px;text-align:center;white-space:normal;background-color:#FFFFFF;">Fax:+86-20-81740602</span>
</p>
<p>
	<span style="color:#333333;font-family:tahoma;font-size:14px;text-align:center;white-space:normal;background-color:#FFFFFF;">E-mail：anson@egoalgroup.com&nbsp;</span>
</p>
<p>
	<span style="color:#333333;font-family:tahoma;font-size:14px;text-align:center;white-space:normal;background-color:#FFFFFF;">Webside: www.egoalgroup.com</span>
</p>								
								<div class="read_more"><a href="case.html" >read more</a></div>
							</div>
						</div>
					</div>
				</div>
		...
		<li id="subnav4" data-title="About us" style="background: #004662 url('../Public/images/in_img2.jpg') top center no-repeat;">
					<div class="difference_teaser white">
						<div class="text_box_right">
							<div class="headline">
								<h3 class="double"><div class="white">Egoal International Logistics Ltd</div></h3>
							</div>
							<div class="text">
								<div class="white">By choosing deugro, you choose a team consisting of the best minds in the freight forwarding business. Our ambition is not only to provide you with leading solutions for all of your project requirements, but to make you experience the deugro difference.</div>
<div class="white">EVERYDAY. EVERYWHERE.</div>							</div>
							<a href="difference.html"  class="btn_full_teaser">About us</a>
						</div>
					</div>
				</li>
		<li id="subnav5" data-title="service project" style="background: #fefefe url('../Public/images/in_img.jpg') top center no-repeat;">
			<div class="difference_teaser">
				<div class="text_box_left">
					<div class="headline">
						<h3 class="double">Our service project</h3>
					</div>
					<div class="text">
						Our company has good relations with International well-known Ocean carriers especially Africa line , we signed contracts with many ocean carriers ,we are not only assure customer space, but also offer our customer better rate and service. Operating LCL(bulk cargo) and Console business from Guangzhou, Shenzhen ,or Hong Kong to Africa, India/Pakistan, the Middle East, Australia, Southeast Asia, and other parts of the world.						
					</div>
					<a href="solution.html"  class="btn_full_teaser">Service project</a>
				</div>
			</div>
		</li>
		<li id="subnav6" data-title="News" style="background: #004561 url('../Public/images/in_img3.jpg') top center no-repeat;">
			<div class="difference_teaser white">
				<?php  $_result=M("Article")->field("id,catid,url,title,title_style,keywords,description,thumb,createtime")->where(" 1  and lang=2 AND status=1  AND catid=24  AND posid =9")->order("id desc")->limit("1")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><div class="text_box_right">
					<div class="headline">
						
						<h3 class="double"><div class="white"><?php echo ($r["title"]); ?></div></h3>
					</div>
					<div class="text">
						<span class="white">
							<?php echo ($r["description"]); ?>
						</span>							</div>
					<a href="<?php echo ($r["url"]); ?>"  class="btn_full_teaser">To see more news</a>
				</div><?php endforeach; endif;?>
			</div>
		</li>
		
		<li id="subnav7" data-title="customers" style="background: #ffffff url('../Public/images/in_img4.jpg') top center no-repeat;">
			<div class="difference_teaser">
				<div class="text_box_left">
					<div class="headline">
						<h3 class="double">Recognition from our customers</h3>
					</div>
					<div class="text">
						<div class="black"><span lang="EN-US">
							<p style="height: 25px;	background: url(../Public/images/pgl.png) no-repeat left center;"></p>
							
							Enter the shipping order number from here, real-time field check your goods Enter the shipping order number from here, real-time field check your goodsEnter the shipping order number from here, real-time field check your goodsfield check your goods.
							
							<p style="height: 25px;background: url(../Public/images/pgr.png) no-repeat right center;">
						</span></div>
					</div>
					<a href="/"  class="btn_full_teaser">See more evaluation</a>
				</div>
			</div>
		</li>
	</ul>
...
$(function(){
	...
	if($(window).width()<768){
		$('#subnav4').css('background-position','68% center');
		$('#subnav5').css('background-position','20% center');
		$('#subnav6').css('background-position','60% center');
		$('#subnav7').css('background-position','30% center');
	}
