    ...
    <table width="100%" cellspacing="0">
		<thead>
      	...
      	<tbody>
			...
			<td align="center"><a href="<?php echo U($module_name.'/edit',array(id=>$vo['id']));?>"><?php echo L('edit');?></a> | <a href="javascript:confirm_delete('<?php echo U($module_name.'/delete',array(id=>$vo['id']));?>')"><?php echo L('delete');?></a> | <a href="<?php echo U($module_name.'/copy',array(id=>$vo['id']));?>"><?php echo L('copy');?></a></td>
