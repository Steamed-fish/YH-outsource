...
INSERT INTO `mqu_access` (`role_id`, `node_id`, `level`, `pid`, `model`, `status`) VALUES
(2, 157, 3, 3, '', 0),
(2, 158, 3, 3, '', 0),
(2, 156, 3, 151, '', 0),
(2, 155, 3, 151, '', 0),
...
CREATE TABLE IF NOT EXISTS `mqu_article` (
  ...
  `thumb_alt` varchar(100) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `mqu_category` (
  ...
  `ismenudescription` tinyint(1) unsigned NOT NULL,
  `menudescription` mediumtext NOT NULL,
  ...
  `appBanner` varchar(150) NOT NULL,
  PRIMARY KEY (`id`),
...
('mail_port', '邮件发送端口', 4, '465', 0),
('mail_from', '发件人地址', 4, '2851762177@qq.com', 0),
('mail_auth', 'AUTH LOGIN验证', 4, '1', 0),
('mail_ssl', 'SSL验证', 4, '1', 0),
('mail_user', '验证用户名', 4, '2851762177@qq.com', 0),
('mail_password', '验证密码', 4, 'hpdkithkprehdceh', 0),
...
('ADMIN_DEFAULT_LANG', '默认语言', 6, 'zh-cn', 0),
('ADMIN_LANG_ON', '后台语言开关', 6, '0', 0),
...
('ADMIN_VERIFY', '后台登陆验证码', 6, '0', 0),
('site_name', '网站名称', 2, '广州市欧陆建材有限公司', 2),
('site_url', '网站网址', 2, '/en', 2),
('logo', '网站LOGO', 2, '/Apps/Tpl/Home/Default/Public/images/logo.jpg', 2),
('site_email', '站点邮箱', 2, 'azch168@163.com', 2),
('seo_title', '网站标题', 2, '广州市欧陆建材有限公司', 2),
('seo_keywords', '关键词', 2, '广州市欧陆建材有限公司', 2),
('seo_description', '网站简介', 2, '广州市欧陆建材有限公司', 2),
...
('promote_head', '头部推广代码', 1, '', 2),
('promote_foot', '底部推广代码', 1, '', 2),
('promote_head', '头部推广代码', 1, '', 1),
('promote_foot', '底部推广代码', 1, '', 1);
...
(1, 0, 0, 'admin', '登录成功', '127.0.0.1', 1514948041);
...
(102, 3, 'Product', '', '', 1, 1, 0, '产品模型', '产品模型', 2),
(105, 102, 'Product', 'add', '', 1, 1, 0, '添加产品', '', 0);
...
CREATE TABLE IF NOT EXISTS `mqu_module` (
  ...
  `postgroup` varchar(100) NOT NULL DEFAULT '',
  `ispost` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `parent_moduleid` varchar(100) NOT NULL,
  PRIMARY KEY (`id`)
...
INSERT INTO `mqu_module` (`id`, `title`, `name`, `description`, `type`, `issystem`, `issearch`, `listfields`, `setup`, `listorder`, `status`, `postgroup`, `ispost`, `parent_moduleid`) VALUES
...
(3, '产品模型', 'Product', '产品展示', 1, 1, 1, '*', '', 0, 1, '', 0, ''),
...
(6, '信息反馈', 'Feedback', '信息反馈', 1, 0, 0, '*', '', 0, 0, '1,2,3,4', 0, ''),
...
('db14843cfccfc2650646b530a55a5edd', 0, '', '127.0.0.1', 1514948033, 4);
...
CREATE TABLE IF NOT EXISTS `mqu_picture` (
  ...
  `title_style` varchar(40) NOT NULL DEFAULT '',
  `thumb` varchar(100) NOT NULL DEFAULT '',
  `thumb_alt` varchar(255) NOT NULL DEFAULT '',
  `keywords` varchar(120) NOT NULL DEFAULT '',
  `description` mediumtext NOT NULL,
  `content` mediumtext NOT NULL,
  `url` varchar(150) NOT NULL DEFAULT '',
...
--
-- 转存表中的数据 `mqu_role_user`
--

INSERT INTO `mqu_role_user` (`role_id`, `user_id`) VALUES
(1, 2);
...
(46, 'Cangshan D Series 59120 German Steel Forged Chefs Knife', 'angshaneries59120ermanteelorgedhefsnife', 3, 'Product', 1, 2),
(47, ' 8-Inch', '8nch', 3, 'Product', 1, 2);
...
(2, 1, 'admin1', '028f7d148d43fc78c45a337ff78abfba7dfb90ee', '617868016@qq.com', '', '', '', 1, '', '', '', '', '', 4, 1481696281, 0, 1481878002, '127.0.0.1', '127.0.0.1', 1, '0.00', 0, ''),
(3, 1, 'admin', '75b3817a97962e6a952d9624a2429e6971ec5831', '1@qq.com', '', '', '', 1, '', '', '', '', '', 9, 1481696281, 0, 1514948041, '127.0.0.1', '127.0.0.1', 1, '0.00', 0, '');
