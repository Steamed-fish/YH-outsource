...
function up_images(iframeWin, topWin,id,inputid){ 
		...
		if(num){
			iframeWin.$('#myuploadform  div ').each(function(){
					...
					data += '<div id="uplist_'+aid+'">'+aidinput+'<input type="text" size="50" class="input-text" name="'+inputid+'[]" value="'+src+'"  />  <input type="text" class="input-text" name="'+inputid+'_name[]" value="'+name+'" size="25" />   <input type="text" class="input-text" name="'+inputid+'_alt[]" value="" placeholder="图片描述" size="25" />&nbsp;<a href="javascript:remove_this(\'uplist_'+aid+'\');">移除</a> </div>';
			});			
