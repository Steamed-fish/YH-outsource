		...
		if(is_array($this->categorys)) {
			foreach($this->categorys as $id => $cat) {
				...
				$this->categorys[$id]['parentdir'] =	$cat['parentdir'] = $parentdir = $this->get_parentdir($id);
	 			...
	 			$cat['parentdir'] = str_replace(' ', '', $cat['parentdir']);
	 			$parentdir = $cat['catdir'] = str_replace(' ', '', $cat['catdir']);
				...
				$this->dao->save(array('catdir'=>$cat['catdir'], 'url'=>$url,'parentdir'=>$parentdir,'arrparentid'=>$arrparentid,'arrchildid'=>$arrchildid,'child'=>$child,'id'=>$id));
			}
		}
	}
