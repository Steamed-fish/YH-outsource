...
class FrontPage extends Think {
	...
	public function  show(){
		...
		$output .= '<li><a class="page-prev arrow-left-b" href="'.$this->pageurl($urlrule, $pre_page,$this->parameter).'">上一页</a></li>';
		...
		$output .='<li><a class="page-next arrow-right-a" href="'.$this->pageurl($urlrule,$next_page,$this->parameter).'">下一页</a></li>'; 
