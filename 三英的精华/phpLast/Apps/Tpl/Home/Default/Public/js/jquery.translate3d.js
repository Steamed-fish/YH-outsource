...
(function(e, t) {
    ...
    e.Gallery.prototype = {
        ...
        _layout: function() {
            this._setItems();
            var e, t, n;
            this.support3d && this.supportTrans ? (e = {
            ...
            e.opacity = 1, e.visibility = "visible", t.opacity = 1, t.visibility = "visible") : this.support2d && this.supportTrans && (e = {
        ...
        _setItems: function() {
            ...
            !this.support3d && this.support2d && this.supportTrans && (this.$items.css("z-index", 1), this.$currentItm.css("z-index", 999)),
            this.itemsCount > 3 && (this.$nextItm = this.$rightItm.index() === this.itemsCount - 1 ? this.$items.eq(0) : this.$rightItm.next(), this.$nextItm.css(this._getCoordinates("outright")), this.$prevItm = this.$leftItm.index() === 0 ? this.$items.eq(this.itemsCount - 1) : this.$leftItm.prev(), this.$prevItm.css(this._getCoordinates("outleft")))
        },
        ...
        _getCoordinates: function(e) {
            if (this.support3d && this.supportTrans) switch (e) {
            case "outleft":
                return {
                    "-webkit-transform":
            ...
            } else if (this.support2d && this.supportTrans) switch (e) {
            case "outleft":
                return {
                    "-webkit-transform":
