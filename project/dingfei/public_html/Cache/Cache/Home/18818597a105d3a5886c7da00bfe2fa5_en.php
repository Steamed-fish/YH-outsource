...
<div class='container download-list'>
    ...
    <div class="row">
        ...
        <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><li class='col-sm-6 col-md-4 col-xs-12'>
                <div class='col-xs-5'>
                    <img src="<?php echo ($r["thumb"]); ?>"  width="100%" />
                </div>
                <div class='col-xs-7'>
                    <a target="_blank" href='<?php echo ($r["file"]); ?>' >
