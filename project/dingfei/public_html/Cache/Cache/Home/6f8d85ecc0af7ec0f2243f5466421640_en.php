...
<div class='container contact'>
    ...
    <div class="offices no-animates">
      <h2>各地办事处</h2><br/>
      <ul id="office-list">
        <?php  $_result=M("Office")->field("*")->where(" 1  and lang=2 AND status=1 ")->order("id desc")->limit("0")->select();; if ($_result): $i=0;foreach($_result as $key=>$r):++$i;$mod = ($i % 2 );?><li <?php if($key == 0) : ?>class='active'<?php endif;?>>
