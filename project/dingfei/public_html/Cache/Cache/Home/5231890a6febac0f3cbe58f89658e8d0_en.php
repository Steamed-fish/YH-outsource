...
<div class="container solu-list">
  <div class="row">
    <ul class="carousel recommand-carousel">
      <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><li class="col-sm-4 col-md-3 col-xs-6">
          <a href='<?php echo ($r["url"]); ?>'  
            class="overout not-margin" style='background-image: url(<?php echo (thumb2($r["thumb"],297,400,2)); ?>)'>
            <img alt='<?php echo ($r["title"]); ?>' src='<?php echo ($r["thumb"]); ?>' />
          </a>
          <div>
            <?php echo ($r["title"]); ?>
            <span><?php echo ($r["en_title"]); ?></span>
          </div>
        </li><?php endforeach; endif; else: echo "" ;endif; ?>
    </ul>
  </div>
