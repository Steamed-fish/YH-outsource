...
<div class='container news-list'>
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><div class="row">
      <dl class='news'>
        <dt class='col-sm-2 col-md-1 col-xs-3 nopad'>
          <b><?php echo (todate($r["createtime"],'d')); ?></b>
          <span><?php echo (todate($r["createtime"],'Y-m')); ?></span>
        </dt>
        <dd class='col-sm-3 col-md-2 col-xs-8'>
          <a href='<?php echo ($r["url"]); ?>'  class="overout" 
            style='background-image: url(<?php echo (thumb2($r["thumb"],300,175)); ?>)'>
            <img src="<?php echo ($r["thumb"]); ?>"  width="100%" />
          </a>
        </dd>
        <dd class='col-sm-7 col-md-9 col-xs-12 xs-padding'>
          <a href="<?php echo ($r["url"]); ?>"><h3><?php echo ($r["title"]); ?></h3></a>
          <p><?php echo ($r["summary"]); ?></p>
          <!--<?php echo L('浏览次数');?>: <?php echo ($r["hits"]); ?>-->
        </dd>
      </dl>
