...
<div class='container product-list'>
    ...
    <div class="row plist">
    <ul class="products">
    <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$r): $mod = ($i % 2 );++$i;?><li class='col-sm-4 col-md-4 col-xs-12 overout-outer'>
            <div>
                <!--362,290-->
