...
<table  class="search_table" width="100%">
	<tr>
		<td class="search">
			...
			<option value=""><?php echo L('listorder');?></option>
			<option value="id" <?php if($order =='id'): ?>selected="selected"<?php endif; ?>>ID</option>
			<option value="hits" <?php if($order =='hits'): ?>selected="selected"<?php endif; ?>><?php echo L('hits');?></option>
			</select>
...
<div class="table-list">
    <table width="100%" cellspacing="0">
		<thead> 
            ...
            <th width="40">ID</th> 
			<th width="100" align="left"><?php echo L('name');?></th> 
            <th width="80" align="left"><?php echo L('type');?></th> 
			<th width="120"  align="left"><?php echo L('skin');?></th> 
            <th  align="left"><?php echo L('code');?></th>            
      	...
      	<tbody>
			...
			<td><?php echo (fieldoption($fields['type'],$vo['type'])); ?></td>
      		<td><?php echo (fieldoption($fields['skin'],$vo['skin'])); ?></td>      		
      		<td><?php echo (stripcslashes($vo['code'])); ?></td>			
