...
<div class="content_2">
	<div class="tabbox" style="display:block;">
      ...
      <tr>
		...
		<tr id="td_cssclass">
		<td><?php echo L('cssclass');?></td>
		<td><input type="text"   id="cssclass" name="cssclass" class="input-text" value="<?php echo ($vo['cssclass']); ?>"  maxlength="30" /></td>
		</tr>
		...
		<td><input type="text" name="url" class="input-text" value="<?php if($vo['type']==1): echo ($vo['url']); endif; ?>" size='50'  /><input type="hidden" id="type" name="type" value="0" /></td>
		  ...
		  <td><textarea name='content' id='content'  rows="5" cols="60" ><?php echo ($vo['content']); ?></textarea></td>
		</tr>
		...
		<tr>
		<td><?php echo L('isfootermenu');?></td>
		<td><?php echo Form::radio(array('field'=>'isfootermenu','options'=>array('1'=>L('yes'),'0'=>L('no'))),$vo['isfootermenu']);?></td>
		</tr>
