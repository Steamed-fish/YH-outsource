...
<table cellpadding=0 cellspacing=0 class="table_form" width="100%">
	...
	<tr>
          ...
          <!-- add by jzp -->
          <?php if($show_catalog==true): ?><option value="catalog" >副栏目</option><?php endif; ?>
...
<!-- add by jzp -->
<?php if($action_name=='edit' && $vo[type]=='catalog'): ?><input type="hidden" name="field" value="<?php echo ($vo["field"]); ?>" /><?php endif; ?>
...
<!-- add by jzp -->
<?php if($action_name=='edit' && $vo[type]=='catalog'): ?>$('#field').attr('disabled', 'disabled');<?php endif; ?>
