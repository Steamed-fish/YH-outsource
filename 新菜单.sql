...
CREATE TABLE IF NOT EXISTS `mqu_ad` (
...
(2, 'contact', '右侧联系我们', 1, ' '),
(3, 'footer', '页底', 1, ''),
(4, 'about', 'index about', 2, ''),
(5, 'contact', 'contact us', 2, ''),
(6, 'footer', 'footer', 2, '');
...
CREATE TABLE IF NOT EXISTS `mqu_case` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `userid` int(8) unsigned NOT NULL DEFAULT '0',
  `username` varchar(40) NOT NULL DEFAULT '',
...
(20, 'About Us', 'about', '', 0, 1, 'Page', '0', '20', 0, '', '', '', 0, 0, 1, 0, '', 0, '/about/', '', '', 0, '', 0, 2, 4, 0, 0, 0, 0, ''),
(21, 'PRODUCT', 'product', '', 0, 3, 'Product', '0', '21', 0, '', '', '', 0, 0, 1, 0, '', 0, '/product/', '', '', 0, '', 0, 2, 4, 0, 0, 0, 0, ''),
(22, 'FACTORY TOUR', 'factory', '', 0, 4, 'Picture', '0', '22', 0, '', '', '', 0, 0, 1, 0, '', 0, '/factory/', '', '', 0, '', 0, 2, 4, 0, 0, 0, 0, ''),
(23, 'ENGINEERING PROJECTS', 'projects', '', 0, 4, 'Picture', '0', '23', 0, '', '', '', 0, 0, 1, 0, '', 0, '/projects/', '', '', 0, '', 0, 2, 4, 0, 0, 0, 0, ''),
(24, 'News', 'news', '', 0, 2, 'Article', '0', '24', 0, '', '', '', 0, 0, 1, 0, '', 0, '/news/', '', '', 0, '', 0, 2, 4, 0, 0, 0, 0, ''),
(25, 'CONTACT US', 'contact', '', 0, 8, 'Guestbook', '0', '25', 0, '', '', '', 0, 0, 1, 0, '', 0, '/contact/', '', '', 0, '', 0, 2, 4, 0, 0, 0, 0, '');
...
('site_name', '网站名称', 2, '', 1),
('site_url', '网站网址', 2, 'http://lo.zhujl.com', 1),
('logo', '网站LOGO', 2, '/Public/Images/logo.gif', 1),
('site_email', '站点邮箱', 2, 'admin@qq.cn', 1),
('seo_title', '网站标题', 2, '企业建站-企业网站-行业网站建设-门户网站建设', 1),
('seo_keywords', '关键词', 2, '', 1),
('seo_description', '网站简介', 2, '', 1),
...
('site_name', '网站名称', 2, 'cm', 2),
('site_url', '网站网址', 2, 'http://lo.zhujl.com', 2),
('logo', '网站LOGO', 2, '/Apps/Tpl/Home/Default/Public/images/logo_02.png', 2),
('site_email', '站点邮箱', 2, 'admin@qq.cn', 2),
('seo_title', '网站标题', 2, ' cms', 2),
('seo_keywords', '关键词', 2, ' cms', 2),
('seo_description', '网站简介', 2, '', 2),
...
(103, 10, 'catid', '栏目', '', 1, 1, 6, '', '必须选择一个栏目', '', 'catid', '', 1, '', 0, 1, 1),
(104, 10, 'title', '标题', '', 1, 1, 80, '', '标题必须为1-80个字符', '', 'title', 'array (\n  ''thumb'' => ''1'',\n  ''style'' => ''1'',\n  ''size'' => ''55'',\n)', 1, '', 0, 1, 1),
(105, 10, 'keywords', '关键词', '', 0, 0, 80, '', '', '', 'text', 'array (\n  ''size'' => ''55'',\n  ''default'' => '''',\n  ''ispassword'' => ''0'',\n  ''fieldtype'' => ''varchar'',\n)', 1, '', 2, 1, 1),
(106, 10, 'description', 'SEO简介', '', 0, 0, 0, '', '', '', 'textarea', 'array (\n  ''fieldtype'' => ''mediumtext'',\n  ''rows'' => ''4'',\n  ''cols'' => ''55'',\n  ''default'' => '''',\n)', 1, '', 3, 1, 1),
...
(110, 10, 'readpoint', '阅读收费', '', 0, 0, 5, '', '', '', 'number', 'array (\n  ''size'' => ''5'',\n  ''numbertype'' => ''1'',\n  ''decimaldigits'' => ''0'',\n  ''default'' => ''0'',\n)', 1, '3,4', 93, 0, 0),
(111, 10, 'hits', '点击次数', '', 0, 0, 8, '', '', '', 'number', 'array (\n  ''size'' => ''10'',\n  ''numbertype'' => ''1'',\n  ''decimaldigits'' => ''0'',\n  ''default'' => ''0'',\n)', 1, '3,4', 93, 0, 0),
(112, 10, 'readgroup', '访问权限', '', 0, 0, 0, '', '', '', 'groupid', 'array (\n  ''inputtype'' => ''checkbox'',\n  ''fieldtype'' => ''tinyint'',\n  ''labelwidth'' => ''85'',\n  ''default'' => '''',\n)', 1, '3,4', 96, 0, 1),
(113, 10, 'posid', '推荐位', '', 0, 0, 0, '', '', '', 'posid', '', 1, '', 97, 1, 1),
(114, 10, 'template', '模板', '', 0, 0, 0, '', '', '', 'template', '', 1, '3,4', 98, 1, 1),
(115, 10, 'status', '状态', '', 0, 0, 0, '', '', '', 'radio', 'array (\n  ''options'' => ''发布|1\r\n定时发布|0'',\n  ''fieldtype'' => ''tinyint'',\n  ''numbertype'' => ''1'',\n  ''labelwidth'' => ''75'',\n  ''default'' => ''1'',\n)', 1, '3,4', 99, 1, 1),
(116, 11, 'catid', '栏目', '', 1, 1, 6, '', '必须选择一个栏目', '', 'catid', '', 1, '', 0, 1, 1),
(117, 11, 'title', '标题', '', 1, 1, 80, '', '标题必须为1-80个字符', '', 'title', 'array (\n  ''thumb'' => ''1'',\n  ''style'' => ''1'',\n  ''size'' => ''55'',\n)', 1, '', 0, 1, 1),
(118, 11, 'keywords', '关键词', '', 0, 0, 80, '', '', '', 'text', 'array (\n  ''size'' => ''55'',\n  ''default'' => '''',\n  ''ispassword'' => ''0'',\n  ''fieldtype'' => ''varchar'',\n)', 1, '', 2, 1, 1),
(119, 11, 'description', 'SEO简介', '', 0, 0, 0, '', '', '', 'textarea', 'array (\n  ''fieldtype'' => ''mediumtext'',\n  ''rows'' => ''4'',\n  ''cols'' => ''55'',\n  ''default'' => '''',\n)', 1, '', 3, 1, 1),
(120, 11, 'content', '内容', '', 0, 0, 0, '', '', '', 'editor', 'array (\n  ''toolbar'' => ''full'',\n  ''default'' => '''',\n  ''height'' => '''',\n  ''showpage'' => ''1'',\n  ''enablekeylink'' => ''0'',\n  ''replacenum'' => '''',\n  ''enablesaveimage'' => ''0'',\n  ''flashupload'' => ''1'',\n  ''alowuploadexts'' => '''',\n)', 1, '', 10, 1, 1),
(121, 11, 'createtime', '发布时间', '', 0, 0, 0, '', '', '', 'datetime', '', 1, '3,4', 93, 1, 1),
(122, 11, 'recommend', '允许评论', '', 0, 0, 1, '', '', '', 'radio', 'array (\n  ''options'' => ''允许评论|1\r\n不允许评论|0'',\n  ''fieldtype'' => ''tinyint'',\n  ''numbertype'' => ''1'',\n  ''labelwidth'' => '''',\n  ''default'' => '''',\n)', 1, '3,4', 93, 0, 0),
(123, 11, 'readpoint', '阅读收费', '', 0, 0, 5, '', '', '', 'number', 'array (\n  ''size'' => ''5'',\n  ''numbertype'' => ''1'',\n  ''decimaldigits'' => ''0'',\n  ''default'' => ''0'',\n)', 1, '3,4', 93, 0, 0),
(124, 11, 'hits', '点击次数', '', 0, 0, 8, '', '', '', 'number', 'array (\n  ''size'' => ''10'',\n  ''numbertype'' => ''1'',\n  ''decimaldigits'' => ''0'',\n  ''default'' => ''0'',\n)', 1, '3,4', 93, 0, 0),
(125, 11, 'readgroup', '访问权限', '', 0, 0, 0, '', '', '', 'groupid', 'array (\n  ''inputtype'' => ''checkbox'',\n  ''fieldtype'' => ''tinyint'',\n  ''labelwidth'' => ''85'',\n  ''default'' => '''',\n)', 1, '3,4', 96, 0, 1),
(126, 11, 'posid', '推荐位', '', 0, 0, 0, '', '', '', 'posid', '', 1, '', 97, 1, 1),
(127, 11, 'template', '模板', '', 0, 0, 0, '', '', '', 'template', '', 1, '3,4', 98, 1, 1),
(128, 11, 'status', '状态', '', 0, 0, 0, '', '', '', 'radio', 'array (\n  ''options'' => ''发布|1\r\n定时发布|0'',\n  ''fieldtype'' => ''tinyint'',\n  ''numbertype'' => ''1'',\n  ''labelwidth'' => ''75'',\n  ''default'' => ''1'',\n)', 1, '3,4', 99, 1, 1),
...
(132, 12, 'description', 'SEO简介', '', 0, 0, 0, '', '', '', 'textarea', 'array (\n  ''fieldtype'' => ''mediumtext'',\n  ''rows'' => ''4'',\n  ''cols'' => ''55'',\n  ''default'' => '''',\n)', 1, '', 3, 1, 1),
...
(142, 13, 'createtime', '发布时间', '', 1, 0, 0, '', '', '', 'datetime', '', 0, '3,4', 93, 1, 1),
(143, 13, 'status', '状态', '', 0, 0, 0, '', '', '', 'radio', 'array (\n  ''options'' => ''已审核|1\r\n未审核|0'',\n  ''fieldtype'' => ''tinyint'',\n  ''numbertype'' => ''1'',\n  ''labelwidth'' => ''75'',\n  ''default'' => ''1'',\n)', 0, '3,4', 99, 1, 1),
(144, 14, 'catid', '栏目', '', 1, 1, 6, '', '必须选择一个栏目', '', 'catid', '', 1, '', 0, 1, 1),
(145, 14, 'title', '标题', '', 1, 1, 80, '', '标题必须为1-80个字符', '', 'title', 'array (\n  ''thumb'' => ''1'',\n  ''style'' => ''1'',\n  ''size'' => ''55'',\n)', 1, '', 0, 1, 1),
(146, 14, 'keywords', '关键词', '', 0, 0, 80, '', '', '', 'text', 'array (\n  ''size'' => ''55'',\n  ''default'' => '''',\n  ''ispassword'' => ''0'',\n  ''fieldtype'' => ''varchar'',\n)', 1, '', 2, 1, 1),
(147, 14, 'description', 'SEO简介', '', 0, 0, 0, '', '', '', 'textarea', 'array (\n  ''fieldtype'' => ''mediumtext'',\n  ''rows'' => ''4'',\n  ''cols'' => ''55'',\n  ''default'' => '''',\n)', 1, '', 3, 1, 1),
(148, 14, 'content', '内容', '', 0, 0, 0, '', '', '', 'editor', 'array (\n  ''toolbar'' => ''full'',\n  ''default'' => '''',\n  ''height'' => '''',\n  ''showpage'' => ''1'',\n  ''enablekeylink'' => ''0'',\n  ''replacenum'' => '''',\n  ''enablesaveimage'' => ''0'',\n  ''flashupload'' => ''1'',\n  ''alowuploadexts'' => '''',\n)', 1, '', 10, 1, 1),
(149, 14, 'createtime', '发布时间', '', 0, 0, 0, '', '', '', 'datetime', '', 1, '3,4', 93, 1, 1),
(150, 14, 'recommend', '允许评论', '', 0, 0, 1, '', '', '', 'radio', 'array (\n  ''options'' => ''允许评论|1\r\n不允许评论|0'',\n  ''fieldtype'' => ''tinyint'',\n  ''numbertype'' => ''1'',\n  ''labelwidth'' => '''',\n  ''default'' => '''',\n)', 1, '3,4', 93, 0, 0),
(151, 14, 'readpoint', '阅读收费', '', 0, 0, 5, '', '', '', 'number', 'array (\n  ''size'' => ''5'',\n  ''numbertype'' => ''1'',\n  ''decimaldigits'' => ''0'',\n  ''default'' => ''0'',\n)', 1, '3,4', 93, 0, 0),
(152, 14, 'hits', '点击次数', '', 0, 0, 8, '', '', '', 'number', 'array (\n  ''size'' => ''10'',\n  ''numbertype'' => ''1'',\n  ''decimaldigits'' => ''0'',\n  ''default'' => ''0'',\n)', 1, '3,4', 93, 0, 0),
(153, 14, 'readgroup', '访问权限', '', 0, 0, 0, '', '', '', 'groupid', 'array (\n  ''inputtype'' => ''checkbox'',\n  ''fieldtype'' => ''tinyint'',\n  ''labelwidth'' => ''85'',\n  ''default'' => '''',\n)', 1, '3,4', 96, 0, 1),
(154, 14, 'posid', '推荐位', '', 0, 0, 0, '', '', '', 'posid', '', 1, '', 97, 1, 1),
(155, 14, 'template', '模板', '', 0, 0, 0, '', '', '', 'template', '', 1, '3,4', 98, 1, 1),
(156, 14, 'status', '状态', '', 0, 0, 0, '', '', '', 'radio', 'array (\n  ''options'' => ''发布|1\r\n定时发布|0'',\n  ''fieldtype'' => ''tinyint'',\n  ''numbertype'' => ''1'',\n  ''labelwidth'' => ''75'',\n  ''default'' => ''1'',\n)', 1, '3,4', 99, 1, 1);
...
CREATE TABLE IF NOT EXISTS `mqu_home` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `userid` int(8) unsigned NOT NULL DEFAULT '0',
  `username` varchar(40) NOT NULL DEFAULT '',
...
(4, 0, 0, 'admin', '登录成功', '127.0.0.1', 1473749483),
(5, 0, 0, 'admin', '登录成功', '127.0.0.1', 1473831865),
(6, 0, 0, 'admin', '登录成功', '127.0.0.1', 1473839401),
(7, 0, 0, 'admin', '登录成功', '127.0.0.1', 1473839459),
(8, 0, 0, 'admin', '登录成功', '127.0.0.1', 1473839551);
...
(1, 0, 'Index', 'main', 'menuid=42', 1, 0, 0, '后台首页', '', 0),
(2, 0, 'Config', '', 'menuid=50', 1, 0, 0, '系统设置', '系统设置', 1),
...
(39, 2, 'Menu', '', '', 1, 0, 0, '后台管理菜单', '后台管理菜单', 11),
(15, 39, 'Menu', 'add', '', 1, 0, 0, '添加菜单', '', 0),
(50, 2, 'Config', '', '', 1, 0, 0, '站点配置', '', 0),
(22, 3, 'Product', '', '', 1, 0, 0, '产品模型', '', 3),
(8, 50, 'Config', 'sys', '', 1, 0, 0, '系统参数', '', 0),
(32, 50, 'Config', 'member', '', 1, 0, 0, '用户中心设置', '', 0),
(59, 50, 'Config', 'add', '', 1, 0, 0, '添加系统变量', '', 99),
(9, 5, 'User', '', '', 1, 0, 0, '会员资料管理', '', 0),
(10, 9, 'User', 'add', '', 1, 0, 0, '添加会员', '', 0),
(11, 5, 'Role', '', '', 1, 0, 0, '会员组管理', '', 0),
(12, 11, 'Role', 'add', '', 1, 0, 0, '添加会员组', '', 0),
(13, 5, 'Node', '', '', 1, 0, 0, '权限节点管理', '', 0),
(14, 13, 'Node', 'add', '', 1, 0, 0, '添加权限节点', '', 0),
(16, 3, 'Module', '', '', 1, 0, 0, '模型管理', '', 99),
(17, 3, 'Category', '', '', 1, 0, 0, '栏目管理', '栏目管理', 1),
(18, 16, 'Module', 'add', '', 1, 0, 0, '添加模型', '', 0),
(19, 17, 'Category', 'add', '', 1, 0, 0, '添加栏目', '', 0),
(20, 3, 'Article', '', '', 1, 0, 0, '文章模型', '', 2),
(21, 20, 'Article', 'add', '', 1, 0, 0, '添加文章', '', 0),
(23, 2, 'Posid', '', '', 1, 0, 0, '推荐位管理', '', 0),
(24, 23, 'Posid', 'add', '', 1, 0, 0, '添加推荐位', '', 0),
(25, 22, 'Product', 'add', '', 1, 0, 0, '添加产品', '', 0),
(26, 3, 'Picture', '', '', 1, 0, 0, '图片模型', '', 4),
(27, 3, 'Download', '', '', 1, 0, 0, '下载模型', '', 5),
(28, 2, 'Type', '', '', 1, 0, 0, '类别管理', '', 6),
(29, 50, 'Config', 'mail', '', 1, 0, 0, '系统邮箱', '', 0),
(30, 50, 'Config', 'attach', '', 1, 0, 0, '附件配置', '', 0),
(31, 17, 'Category', 'repair_cache', '', 1, 0, 0, '恢复栏目数据', '', 0),
(33, 6, 'Createhtml', 'index', '', 1, 0, 0, '更新首页', '', 0),
(34, 6, 'Createhtml', 'Createlist', '', 1, 0, 0, '更新列表页', '', 0),
(35, 6, 'Createhtml', 'Createshow', '', 1, 0, 0, '更新内容页', '', 0),
(36, 6, 'Createhtml', 'Updateurl', '', 1, 0, 0, '更新内容页url', '', 0),
(37, 26, 'Picture', 'add', '', 1, 0, 0, '添加图片', '', 0),
(38, 27, 'Download', 'add', '', 1, 0, 0, '添加文件', '', 0),
(40, 1, 'Index', 'password', '', 1, 0, 0, '修改密码', '', 2),
(41, 1, 'Index', 'profile', '', 1, 0, 0, '个人资料', '', 3),
(42, 1, 'Index', 'main', '', 1, 0, 0, '后台首页', '', 1),
(43, 17, 'Category', 'add', '&type=1', 1, 0, 0, '添加外部链接', '', 0),
(44, 2, 'Database', '', '', 1, 0, 0, '数据库管理', '', 0),
(45, 44, 'Database', 'query', '', 1, 0, 0, '执行SQL语句', '', 0),
(46, 44, 'Database', 'recover', '', 1, 0, 0, '恢复数据库', '', 0),
(47, 1, 'Index', 'cache', 'menuid=47', 1, 0, 0, '更新缓存', '', 4),
(48, 51, 'Module', 'add', 'type=2', 1, 0, 0, '创建模块', '', 0),
(49, 3, 'Feedback', 'index', '', 1, 0, 0, '信息反馈', '信息反馈', 7),
(51, 4, 'Module', 'index', 'type=2', 1, 0, 0, '模块管理', '', 0),
(52, 28, 'Type', 'add', '', 1, 0, 0, '添加类别', '', 0),
(53, 4, 'Link', 'index', '', 1, 0, 0, '友情链接', '', 0),
(54, 53, 'Link', 'add', '', 1, 0, 0, '添加链接', '', 0),
(55, 3, 'Guestbook', 'index', '', 1, 0, 0, '在线留言', '', 8),
(56, 4, 'Kefu', 'index', '', 1, 0, 0, '在线客服', '', 0),
(57, 56, 'Kefu', 'add', '', 1, 0, 0, '添加客服', '', 0),
(58, 4, 'Order', 'index', '', 1, 0, 0, '订单管理', '', 0),
(60, 7, 'Template', 'index', '', 1, 0, 0, '模板管理', '', 0),
(61, 60, 'Template', 'add', '', 1, 0, 0, '添加模板', '', 0),
(62, 60, 'Template', 'index', 'type=css', 1, 0, 0, 'CSS管理', '', 0),
(63, 60, 'Template', 'index', 'type=js', 1, 0, 0, 'JS管理', '', 0),
(64, 60, 'Template', 'images', '', 1, 0, 0, '媒体文件管理', '', 0),
(65, 7, 'Theme', 'index', 'menuid=65', 1, 0, 0, '风格管理', '', 0),
(66, 65, 'Theme', 'upload', '', 1, 0, 0, '上传风格', '', 0),
(67, 2, 'Urlrule', 'index', '', 1, 0, 0, 'URL规则', '', 0),
(68, 67, 'Urlrule', 'add', '', 1, 0, 0, '添加规则', '', 0),
(69, 2, 'Dbsource', 'index', '', 1, 0, 0, 'DB数据源', '', 0),
(70, 69, 'Dbsource', 'add', '', 1, 0, 0, '添加数据源', '', 0),
(71, 2, 'Lang', 'index', '', 1, 0, 0, '多语言管理', '语言管理', 0),
(72, 71, 'Lang', 'add', '', 1, 0, 0, '添加语言', '', 0),
(73, 71, 'Lang', 'param', '', 1, 0, 0, '设置语言包', '', 0),
(74, 7, 'Block', 'index', '', 1, 0, 0, '碎片管理', '', 0),
(75, 74, 'Block', 'add', '', 1, 0, 0, '添加碎片', '', 0),
(76, 60, 'Template', 'config', '', 1, 0, 0, '模板参数配置', '', 0),
(77, 7, 'Slide', 'index', '', 1, 0, 0, '幻灯片管理', '', 0),
(78, 77, 'Slide', 'add', '', 1, 0, 0, '添加幻灯片', '', 0),
(79, 4, 'Payment', 'index', '', 1, 0, 0, '在线支付', '', 0),
(80, 79, 'Shipping', '', '', 1, 0, 0, '配送方式', '', 0),
(81, 79, 'Shipping', 'add', 'isajax=1', 1, 0, 0, '添加配送方式', '', 0),
(82, 58, 'Order', 'orderlist', '', 1, 0, 0, '单据管理', '', 0),
(83, 1, 'Log', 'index', '', 1, 0, 0, '后台登陆日志', '', 83),
(84, 2, 'Upgrade', 'index', '', 1, 0, 0, '在线升级', '', 0),
(85, 84, 'Upgrade', 'checkfile', '', 1, 0, 0, '文件校检', '', 0),
(86, 6, 'Createhtml', 'createsitemap', '', 1, 0, 0, '生成网站地图', '', 0),
(87, 6, 'Createhtml', 'upload', 'moduleid=3', 1, 0, 0, '批量导入产品', '', 0),
(88, 0, 'Set', '', '', 1, 1, 0, '设置', '', 0),
(89, 88, 'Config', 'index', '', 1, 1, 0, '网站基本设置', '', 0),
(190, 3, 'Ad', 'index', '', 1, 1, 0, '广告管理', '', 9),
(191, 90, 'Ad', 'add', '', 1, 1, 0, '添加信息', '', 9),
(192, 3, 'Home', 'index', '', 1, 1, 0, '首页内容', '', 9),
(193, 92, 'Home', 'add', '', 1, 1, 0, '添加信息', '', 9),
(194, 3, 'Share', 'index', '', 1, 1, 0, '分享', '', 9),
(195, 94, 'Share', 'add', '', 1, 1, 0, '添加信息', '', 9),
(196, 3, 'Property', 'index', '', 1, 1, 0, '产品属性', '', 9),
(197, 96, 'Property', 'add', '', 1, 1, 0, '添加信息', '', 9),
(198, 3, 'Case', 'index', '', 1, 1, 0, '案例模型', '', 9),
(199, 98, 'Case', 'add', '', 1, 1, 0, '添加信息', '', 9),
(90, 88, 'Theme', 'index', 'menuid=91', 1, 1, 0, '模块管理', '', 0),
(91, 90, 'Theme', 'index', '', 1, 1, 0, '风格管理', '', 0),
(92, 90, 'Home', 'index', '', 1, 1, 0, '首页内容', '', 0),
(93, 90, 'Home', 'nav', '', 1, 1, 0, '导航设置', '', 0),
(94, 90, 'Home', 'footernav', '', 1, 1, 0, '底部栏目设置', '', 0),
(95, 90, 'Home', 'headernav', '', 1, 1, 0, '顶部导航设置', '', 0),
(96, 88, 'User', 'index', '', 1, 1, 0, '管理员管理', '', 0),
(97, 88, 'Log', 'index', '', 1, 1, 0, '系统日志', '', 0),
(98, 88, 'Kefu', 'index', '', 1, 1, 0, '客服管理系统', '', 0),
(99, 0, 'Content', '', 'menuid=101', 1, 1, 0, '内容', '', 0),
(100, 99, 'Page', '', 'menuid=101', 1, 1, 0, '单页信息管理', '', 0),
(101, 100, 'Page', 'index', '', 1, 1, 0, '单页管理', '', 0),
(102, 99, 'Article', 'index', '', 1, 1, 0, '文章管理', '', 0),
(103, 99, 'Link', 'index', '', 1, 1, 0, '友情链接', '', 0),
(104, 99, 'Ad', 'index', '', 1, 1, 0, '广告管理', '', 0),
(105, 99, 'Guessage', 'index', 'menuid=106', 1, 1, 0, '留言管理', '', 0),
(106, 105, 'Guessage', 'index', '', 1, 1, 0, '留言列表', '', 0),
(107, 105, 'Field', 'index', 'moduleid=8', 1, 1, 0, '留言设置', '', 0),
(108, 99, 'Share', 'index', '', 1, 1, 0, '分享管理', '', 0),
(109, 0, 'Product', '', 'menuid=110', 1, 1, 0, '产品', '', 0),
(110, 109, 'Product', 'index', '', 1, 1, 0, '产品管理', '', 0),
(111, 109, 'Property', 'index', '', 1, 1, 0, '产品属性模板', '', 0),
(112, 109, 'Categorys', 'index', 'moduleid=3', 1, 1, 0, '产品类目管理', '', 0),
(113, 109, 'Feedback', 'index', 'menuid=114', 1, 1, 0, '询盘管理', '', 0),
(114, 113, 'Feedback', 'index', '', 1, 1, 0, '询盘列表', '', 0),
(115, 113, 'Field', 'index', 'moduleid=6', 1, 1, 0, '询盘设置', '', 0),
(116, 109, 'Createhtml', 'upload', 'moduleid=3', 1, 1, 0, '产品批量上传', '', 0),
(117, 0, 'Case', 'index', 'menuid=118', 1, 1, 0, '案例', '', 0),
(118, 117, 'Case', 'index', '', 1, 1, 0, '案例管理', '', 0),
(119, 117, 'Categorys', 'index', 'moduleid=14', 1, 1, 0, '案例类目管理', '', 0),
(120, 0, 'Download', 'index', 'menuid=121', 1, 1, 0, '下载', '', 0),
(121, 120, 'Download', 'index', '', 1, 1, 0, '下载文件管理', '', 0),
(122, 120, 'Categorys', 'index', 'moduleid=5', 1, 1, 0, '下载类目管理', '', 0),
(123, 0, 'Seo', 'index', 'menuid=125', 1, 1, 0, '推广', '', 0),
(124, 123, 'Seo', 'index', 'menuid=125', 1, 1, 0, '网站优化管理', '', 0),
(125, 124, 'Seo', 'index', '', 1, 1, 0, '页面标题与标签管理', '', 0),
(126, 124, 'Block', 'index', '', 1, 1, 0, '第三方代码', '', 0),
(127, 124, 'Createhtml', 'createsitemap', '', 1, 1, 0, '网站地图', '', 0);
...
(10, '广告管理', 'Ad', '', 1, 0, 0, '*', '', 0, 0, '', 0),
(11, '首页内容', 'Home', '', 1, 0, 0, '*', '', 0, 0, '', 0),
(12, '分享', 'Share', '', 1, 0, 0, '*', '', 0, 0, '', 0),
(13, '产品属性', 'Property', '', 1, 0, 0, '*', '', 0, 0, '', 0),
(14, '案例模型', 'Case', '', 1, 0, 0, '*', '', 0, 0, '', 0);
...
('3a96af7c19ba86f561029de58e52f5f1', 0, '', '127.0.0.1', 1473839544, 4);
...
INSERT INTO `mqu_page` (`id`, `title`, `thumb`, `keywords`, `description`, `content`, `template`, `listorder`) VALUES
(20, 'About Us', '', '', '', '', '', 0),
(21, 'PRODUCT', '', '', '', '', '', 0);
...
CREATE TABLE IF NOT EXISTS `mqu_property` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0',
  `userid` int(8) unsigned NOT NULL DEFAULT '0',
  `username` varchar(40) NOT NULL DEFAULT '',
...
CREATE TABLE IF NOT EXISTS `mqu_share` (
  `id` int(11) unsigned NOT NULL AUTO_INCREMENT,
  `catid` smallint(5) unsigned NOT NULL DEFAULT '0',
  `userid` int(8) unsigned NOT NULL DEFAULT '0',
  `username` varchar(40) NOT NULL DEFAULT '',
...
(1, 1, 'admin', '64f86111c31a2cd6e492ea68c3a6e29bab3e60c9', 'admin@qq.cn', 'admin', '', '', 0, '', '', '', '', '', 8, 1473132154, 1473132154, 1473839551, '127.0.0.1', '127.0.0.1', 1, '0.00', 0, '');
